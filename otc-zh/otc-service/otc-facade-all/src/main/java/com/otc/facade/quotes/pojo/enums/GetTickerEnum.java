package com.otc.facade.quotes.pojo.enums;
...
public enum GetTickerEnum {
    ...
    SYMBOL("symbol", "51szzcetccny,51szzclskcny,51szzzcashccny,51szzcanscny,51szzcbtccny,51szzcltccny" +
            ",bterzeccny,coinbaseethusd,chbtcetccny,bitfinexethusd,yunbietccny,chbtcethcny," +
            "bterethcny,bterethbtc,yunbiethcny,btceethusd,yanbaozec2cny,yanbaoans2cny,krakenethusd," +
            "bichuangetccny,poloniexethbtc,poloniexetcbtc" +
