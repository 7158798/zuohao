...
public class OSSPostObject {
	...
	public static String URL = new Constant().OSSURL;
    private static String endpoint = new Constant().Endpoint;
    private static String accessKeyId = new Constant().AccessKeyId;
    private static String accessKeySecret = new Constant().AccessKeySecret;
    private static String bucketName = new Constant().BucketName;
    ...
    public boolean PostObject(String name, InputStream inputStream)  {
        boolean flag =false ;
        try {
            // 提交表单的URL为bucket域名
            String urlStr = endpoint.replace("http://", "http://" + bucketName+ ".");
           ...
           /* String filename= filePath;
            ...
            String ret = formUpload(urlStr, formFields, inputStream, name);
...
//            String contentType = new MimetypesFileTypeMap().getContentType(file);
    ...
    private static String formUpload(String urlStr, Map<String, String> formFields, InputStream inputStream, String filename)
            throws Exception {
        String res = "";
        HttpURLConnection conn = null;
        String boundary = "9431149156168";
