...
public class ArticleTypeController extends BaseController {
	...
	@SysLog(code = ModuleConstont.ARTICLE_OPERATION, method = "新增资讯类型")
	public ModelAndView saveArticleType() throws Exception{
		...
		articleType.setfCreateUser(admin);
	...
	@SysLog(code = ModuleConstont.ARTICLE_OPERATION, method = "修改资讯类型")
	...
	@SysLog(code = ModuleConstont.ARTICLE_OPERATION, method = "删除资讯类型")
