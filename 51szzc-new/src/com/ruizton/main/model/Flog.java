...
public class Flog implements java.io.Serializable {
	...
	private Timestamp fcreateTime;//登录时间
	private Integer ftype;
	private String ftype_s;
	private String ftype_en;
	private String fkey1;
	private String fkey2; //登录人
	private String fkey3; //IP地址
	private String fkey4; // sessionId
	private String fkey5;  // 在线时长
	...
	public Flog(Timestamp fcreateTime, Integer ftype, String fkey1,
			String fkey2, String fkey3, String fkey4, String fkey5, String fkey6,String address) {
	...
	public String getFtype_en() {
		return LogTypeEnum.getEnumString_i18n(this.getFtype());
	}
