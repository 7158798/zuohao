...
<div class="pageContent">
    <form method="post" action="ssadmin/saveVideo.html"
        ...
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>
                <dt>视频标题：</dt>
                <dd>
                    <input type="text" name="fTitle" class="required" size="40" maxlength="100"/>
                </dd>
            </dl>
            <dl>
                <dt>视频简介：</dt>
                <dd>
                    <textarea name="fDescription" class="required"  rows="6" cols="50" maxlength="200"></textarea>
                </dd>
            </dl>
            ...
            <dl>
                <dt>视频文件：</dt>
                <dd>
                    <video controls id="videoShow" style="width: 300px;height: 300px;">
                        您的浏览器不支持音频播放
                    </video>
                </dd>
            </dl>
            <dl>
                <dt>视频上传：</dt>
                <dd>
                    <input type="hidden" name="fVideoUrl" id="fVideoUrl"/>
                    <input type="file" id="video" onchange="uploadVideo()" class="required"/><br/>
            ...
            <dl>
                <dt>封面上传：</dt>
                <dd>
                    <input type="hidden" name="fPictureUrl" id="fPictureUrl" />
                    <input type="file" id="firstImg" onchange="uploadVideoFirsrImg()" class="required"/><br/>
