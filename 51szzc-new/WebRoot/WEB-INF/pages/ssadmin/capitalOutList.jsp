		...
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/capitalOutAudit1.html">
				<li>
					<c:if test="${isneedpwd  == 1}">
						<li><a class="edit"
						href="ssadmin/goCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/capitalOutAudit"
						height="320" width="800"  rel="capitalOutAudit" target="dialog"><span>审核</span>
						</a>
					</c:if>
			...
			<shiro:hasPermission name="ssadmin/capitalOutAudit4.html">
				<%--<li><a class="edit"--%>
					...
					<a class="edit"
					   href="ssadmin/goCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/capitalOutCancel"
					   height="320" width="800" target="dialog"
					   rel="capitalOutCancel" title="确定要取消提现吗?"><span>取消提现</span>
					</a>
				</li>
