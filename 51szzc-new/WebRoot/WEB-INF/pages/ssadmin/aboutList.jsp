...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/addAbout">
				<li><a class="add"
					href="ssadmin/goAboutJSP.html?url=ssadmin/addAbout" height="500"
					width="900" target="dialog" rel="addAbout"><span>新增</span> </a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/deleteAbout.html">
				<li><a class="delete"
