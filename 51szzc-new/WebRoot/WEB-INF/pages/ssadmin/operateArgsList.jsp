...
<form id="pagerForm" method="post" action="ssadmin/operateArgsList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ssadmin/operateArgsList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/updateOperateArgs.html">
				<li><a class="edit"
