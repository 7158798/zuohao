...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
            <shiro:hasPermission name="ssadmin/addUser.html">
		         <li> <a class="edit"
					href="ssadmin/addUsers.html"
					target="ajaxTodo" title="确定要增加10个会员吗?"><span>增加会员</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/userForbbin1.html">
				...
				<li>
					<a class="edit"
					   href="ssadmin/goUserJSP.html?uid={sid_user}&url=ssadmin/frozen"
					   target="dialog" rel="ffreezeUser"><span>冻结</span>
					</a>
				</li>
			</shiro:hasPermission>
		   ...
		   <shiro:hasPermission name="ssadmin/userForbbin6.html">
				<li><a class="edit"
					...
					target="ajaxTodo" title="确定要重置手机号码吗?"><span>重置手机</span>
				</a>
				</li>
		</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/cancelsafe.html">
				<li><a class="edit"
					   href="ssadmin/cancelsafe.html?uid={sid_user}"
					   target="ajaxTodo" title="确定要重置安全问题验证吗?"><span>重置安全问题验证</span>
				</a>
				</li>
			</shiro:hasPermission>
        ...
        <shiro:hasPermission name="ssadmin/updateIntroPerson.html">
			<li><a class="edit"
		...
		<shiro:hasPermission name="ssadmin/realCertification.html">
			<li>
				<a class="edit"
				   href="ssadmin/goUserJSP.html?uid={sid_user}&url=ssadmin/realCertification"
				   height="240" width="700" target="dialog" rel="realCertification"><span>实名认证</span>
				</a>
			</li>
		</shiro:hasPermission>
		<shiro:hasPermission name="ssadmin/addAccountBank.html">
			<li>
				<a class="edit"
				   href="ssadmin/goUserJSP.html?uid={sid_user}&url=ssadmin/addAccountBank"
				   height="240" width="800" target="dialog" rel="realCertification"><span>绑定银行卡</span>
				</a>
			</li>
		</shiro:hasPermission>
