		...
		<tbody>
			<c:forEach items="${userList}" var="v" varStatus="num">
				<tr target="sid_user" rel="${v.fid}">
					...
					<td><fmt:formatNumber value="${v.ftotal}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
					<td><fmt:formatNumber value="${v.ffrozen}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
