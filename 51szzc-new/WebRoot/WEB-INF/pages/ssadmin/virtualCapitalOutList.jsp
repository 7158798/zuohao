		...
		<ul class="toolBar">
			...
			<shiro:hasPermission name="ssadmin/viewVirtualCaptual.html?type=3">
				<li>
				    ...
				    <%--</a>--%>
					<a class="edit"
					   href="ssadmin/goVirtualCapitaloperationJSP.html?uid={sid_user}&url=ssadmin/virtualCapitaloperationCanl"
					   height="320" width="800" target="dialog"
					   rel="viewVirtualCapitaloperation" title="确定要取消提币吗?"><span>取消提币</span>
					</a>
				</li>
			</shiro:hasPermission>
		</ul>
