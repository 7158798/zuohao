	...
	<form onsubmit="return navTabSearch(this);"
		...
		<div class="searchBar">
			...
			<table class="searchContent">
				<tr>
					<td>关键字：<input type="text" name="keywords" value="${keywords}" placeholder="请输入资讯类型" size="60" /></td>
				</tr>
			</table>
			<div class="subBar">
				<ul>
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/updateArticleType.html">
				...
				<li><a class="add"
					href="ssadmin/goArticleTypeJSP.html?url=ssadmin/addArticleType1"
					height="300" width="800" target="dialog" rel="addArticleType1"><span>新增</span>
				</a>
				</li>
				<li><a class="delete"
					href="ssadmin/deleteArticleType.html?uid={sid_user}" target="ajaxTodo"
		...
		<thead>
			<tr>
				...
				<th width="60" orderField="fname"
					<c:if test='${param.orderField == "fname" }'> class="${param.orderDirection}"  </c:if>>资讯类型</th>
				<th width="60">描述</th>
		...
		<tbody>
			<c:forEach items="${articleTypeList}" var="articleType"
				...
				<tr target="sid_user" rel="${articleType.fid}">
					...
					<td>${articleType.fCreateUser.fname}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
