...
<form id="pagerForm" method="post" action="ssadmin/capitalOutSucList.html">
	<input type="hidden" name="status" value="${param.status}"> <input
		...
		type="hidden" name="capitalId" value="${capitalId}" />
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="ssadmin/withDrawRMBExport.html">
				<li><a class="icon" href="ssadmin/withDrawRMBExport.html"
	...
	<div class="panelBar">
		...
		<div class="pages">
			<span>总提现金额:<fmt:formatNumber value="${totalWithdraw}" pattern="##.######" maxIntegerDigits="20" maxFractionDigits="6"/></span>
		</div>
		<div class="pages">
