...
<form id="pagerForm" method="post" action="ssadmin/alipayBindList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ssadmin/alipayBindList.html" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>会员信息：<input type="text" name="keywords"
						value="${keywords}" size="60" /></td>
					<td>支付宝帐号：<input type="text" name="account" value="${account}"
						size="40" />
					</td>	
				</tr>
			</table>
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<c:forEach items="${alipaybindList}" var="v" varStatus="num">
