...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="ssadmin/sendVirtualOperationLog">
				<li><a class="edit"
		...
		<tbody>
			<c:forEach items="${virtualoperationlogList}"
				...
				<tr target="sid_user" rel="${virtualoperationlog.fid}">
					...
					<td><fmt:formatNumber value="${virtualoperationlog.ffrozenQty}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
					<td><fmt:formatNumber value="${virtualoperationlog.fqty}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
