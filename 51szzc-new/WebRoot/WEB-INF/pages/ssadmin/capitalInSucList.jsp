...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="ssadmin/capitalInSucListExport.html">
				<li><a class="icon" href="ssadmin/capitalInSucListExport.html"
	...
	<div class="panelBar">
		...
		<div class="pages">
			<span>充值金额:<fmt:formatNumber value="${totalDeposit}" pattern="##.######" maxIntegerDigits="20" maxFractionDigits="6"/></span>
		</div>
		<div class="pages">
