...
<div class="pageContent">
	...
	<form method="post" action="ssadmin/updateAutoOrder.html"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent nowrap" layoutH="97">
			<input type="hidden" name="id" value="${autoOrder.id}" />
			<dl>
				<dt>币种：</dt>
				<dd>
					${autoOrder.ftrademapping.fvirtualcointypeByFvirtualcointype2.fname}
				</dd>
			</dl>
		    <dl>
				<dt>挂单数量：</dt>
