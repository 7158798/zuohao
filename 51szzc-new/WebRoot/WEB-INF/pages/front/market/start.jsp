...
<div style="display: none">
	<form style="display: inline" id="chart_input_interface">
		<input style="display: inline" type="text" autocomplete="off" id="chart_input_interface_text">
	...
	<form style="display: inline" id="chart_output_interface">
		<input style="display: inline" type="text" autocomplete="off" id="chart_output_interface_text">
...
<script type="text/javascript" src="${oss_url}/static/front/js/fullkline/fullKilne.js?t=2016-12-16"></script>
