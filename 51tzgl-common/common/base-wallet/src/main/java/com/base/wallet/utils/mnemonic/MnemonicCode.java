package com.base.wallet.utils.mnemonic;
...
public class MnemonicCode {
    ...
    private static final String BIP39_ENGLISH_RESOURCE_NAME = "/home/lx/lx/mnemonic/wordlist/english.txt";
    ...
    private static InputStream openDefaultWords() throws IOException {
        //InputStream stream = MnemonicCode.class. (BIP39_ENGLISH_RESOURCE_NAME);
        InputStream stream = new FileInputStream(new File(BIP39_ENGLISH_RESOURCE_NAME));
        if (stream == null)
