...
import com.base.wallet.utils.eth.resp.DebugResp;
...
"}]");
	...
	public static void main(String args[]) throws Exception{
		...
		//System.out.println(ethUtils.getbalanceValue("0x07848a7df98197eb87c49f7d020a141871398bec")); ;
		//System.out.println(ethUtils.getbalanceValue("0xae7b68755f3b45a0618cc13cfe3169d96daeaceb")); ;
	...
	//	System.out.println(ethUtils.eth_blockNumberValue());
		...
		for (int i = 0; i < count; i++) {
			...
			if ("0xee8d89a71ef42d2c5c7d54019c491137eb5cdaf93651f54c3ade95bc82a913ec".equals(btcInfo.getTxid())){
				System.out.println(btcInfo.getTxid());
			}
		}*/
...
//    System.out.println(ethUtils.validateaddress("0x07848a7df98197eb87c49f7d020a141871398bec"));
