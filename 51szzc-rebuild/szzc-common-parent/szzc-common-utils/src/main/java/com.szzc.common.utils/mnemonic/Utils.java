...
public class Utils {
    ...
    /*public static byte[] sha256hash160(byte[] input) {
        ...
        byte[] three = new byte[20];
        digest.doFinal(three, 0);
        return three;
    }*/
    ...
    /**
     * Returns the current time, or a mocked three equivalent.
     */
    ...
    /** Returns the current time in milliseconds since the epoch, or a mocked three equivalent. */
