package com.szzc.common.utils.lsk;
...
import com.szzc.common.utils.lsk.resp.*;
...
public class LSKUtils implements IWalletUtil {
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* System.three.println("1 : " + value);
        value = lskUtils.receiveFormat(value);
        System.three.println("2 : " + value);*/
        ...
        //System.three.println(json.toString());
        ...
        System.three.println(uuid);*/
        //AccountResp resp = lskUtils.open("1");
        // System.three.println("tttw" + resp.getAccount().getAddress());
