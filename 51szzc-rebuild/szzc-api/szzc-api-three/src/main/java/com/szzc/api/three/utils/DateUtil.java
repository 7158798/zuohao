...
public abstract class DateUtil {
    ...
    private static SimpleDateFormat TIMESTAMP_FORMAT2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    private static SimpleDateFormat TIMESTAMP_FORMAT_ALL = new SimpleDateFormat("yyyyMMddHHmmssSSS");

    private static SimpleDateFormat TIMESTAMP_FORMAT_ALL2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS");
    ...
    /**
     * 格式化当前时间前一周为参数pattern指定的时间格式字符串.
     *
     * @param pattern
     * @return the formatted date-time string
     * @see SimpleDateFormat
     */
    public static String formatBeforeWeekDateTime(String pattern) {
        try {
            Calendar c = Calendar.getInstance();
     ...
     *
     * @param  sDate, String hour,String minute,String second
     * @return Date
     */
    public static Date string2datetime(String sDate, String hour, String minute, String second) {
        if (!isDate(sDate)) {
            return null;
        }
        try {
    ...
    public static int getMondayPlus(String year, String month, String day) {
        ...
        cal.clear();
        cal.set(new Integer(year).intValue(), new Integer(month).intValue() - 1, new Integer(day).intValue() - 1);
    ...
    public static String getWeekSunday(String year, String month, String day) {
        try {
            ...
            currentDate.set(new Integer(year).intValue(), new Integer(month).intValue() - 1, new Integer(day).intValue() - 1);
    ...
    public static int getYearPlus(String year, String month, String day) {
        GregorianCalendar currentDate = new GregorianCalendar();
        currentDate.set(new Integer(year).intValue(), new Integer(month).intValue() - 1, new Integer(day).intValue());
     ...
     * @return
     */
    public static boolean isgreaterForDateTime(String beginDateTime, String endDateTime) {
        try {
     ...
     * @return
     */
    public static boolean greaterTenDay(String beginDate, String endDate) {
        try {
            Calendar end = Calendar.getInstance();
            end.setTime(parse("yyyyMMdd", endDate));
    ...
    public static boolean greaterOneMonth2(String beginDate, String endDate) {
        try {
            ...
            String endString = DATEFORMAT.format(end.getTime());
            if (Integer.parseInt(beginDate.replace("-", "")) <= Integer.parseInt(endString)) {
                return true;
            }
        } catch (Exception e) {
            return true;
     ...
     * @return
     */
    public static boolean greaterOneMonthForDateTime(String beginDateTime, String endDateTime) {
        try {
            Calendar end = Calendar.getInstance();
     ...
     * @return
     */
    public static int compareDatetimeForMin(Date beginDate, Date endDate, long mins) {
        try {
            Calendar end = Calendar.getInstance();
            end.setTime(endDate);
     ...
     * @return
     */
    public static boolean greater24Hour(Date beginDate, Date endDate) {
        try {
            Calendar end = Calendar.getInstance();
            end.setTime(endDate);
            end.add(Calendar.HOUR, -24);
            Date newEndDate = end.getTime();
            if (newEndDate.compareTo(beginDate) > 0) {
                return true;
            }
        } catch (Exception e) {
            return true;
     ...
     * @return
     */
    public static boolean isNowBeforeBy(Date endDate, int hour) {
        if (endDate == null) {
            return false;
        }
        Calendar cal = Calendar.getInstance();
        ...
        Date endDate_ = cal.getTime();
        Date now = new Date();
        return now.before(endDate_);
    }
     ...
     * @return
     */
    public static boolean isNowAfterBy(Date endDate, int date) {
        if (endDate == null) {
            return false;
        }
        Calendar cal = Calendar.getInstance();
     ...
     * @return
     */
    public static boolean isBeforeDays(Date deadline, int days) {
        if (deadline == null) {
            return false;
        }
        Calendar cal = Calendar.getInstance();
     ...
     * @return
     */
    public static int compareDatetimeForSeconds(Date beginDate, Date endDate, long secs) {
        try {
            Calendar end = Calendar.getInstance();
            end.setTime(endDate);
            long endMillis = end.getTimeInMillis();
    ...
    public static boolean compareDatetime(Date beginDate, Date endDate) {
        try {
            Calendar end = Calendar.getInstance();
            end.setTime(endDate);
            long endMillis = end.getTimeInMillis();
     ...
     * @return
     */
    public static boolean compareDatetimeWithMinsYN(Date startDate, Date endDate, long mins) {
        try {
            Calendar end = Calendar.getInstance();
            end.setTime(endDate);
            long millis1 = end.getTimeInMillis();
     ...
     * @return
     */
    public static Date operateDateForMonth(Date date, Integer i) {
        Calendar cd = Calendar.getInstance();
        cd.setTime(date);
     ...
     * @return
     */
    public static Date getHour24Date(Date date, int hour) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
    ...
    // // System.three.println("compare: "
    // // + DateUtil.compare("20100510", "20100501", 9));
    // //
    // // System.three.println(DateUtil.getYearFromDate(new Date(System.currentTimeMillis())));
    // // System.three.println(DateUtil.getMonthFromDate(new Date(System.currentTimeMillis())));
    // // System.three.println(DateUtil.getDayFromDate(new Date(System.currentTimeMillis())));
    // System.three.println(getCurrenDay());
    //
    // }
     ...
     * @return
     */
    public static Date getDiffDate(Date date, Date date1) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        Calendar cal2 = Calendar.getInstance();
        cal2.setTime(date1);
        Calendar cal3 = Calendar.getInstance();
        cal3.setTimeInMillis(cal.getTimeInMillis() - cal2.getTimeInMillis());
        return cal3.getTime();
    }
    ...
    /**
     * 获取时间区间断时间列表-yyyyMMdd 闭区间
     *
     * @param beginDate
     * @param endDate:指定显示时间格式
     * @return
     */
    public static List getDayList(String beginDate, String endDate) {
        ...
        try {
            ...
            cal0.setTime(begin);
            cal1.setTime(end);
            for (int i = 1; cal1.after(cal0) || cal1.equals(cal0); i++) {
                str = String.valueOf(cal0.get(Calendar.YEAR));
                if (String.valueOf(cal0.get(Calendar.MONTH) + 1).length() == 1) {
                    str = str + "0" + String.valueOf(cal0.get(Calendar.MONTH) + 1);
                } else {
                    str = str + String.valueOf(cal0.get(Calendar.MONTH) + 1);
                }
                if (String.valueOf(cal0.get(Calendar.DATE)).length() == 1) {
                    str = str + "0" + String.valueOf(cal0.get(Calendar.DATE));
                } else {
    ...
    /**
     * 获得currentDate+i年的时间 2012-01-01 00:01:00 +count（2） 2014-01-01 00:01:00
     *
     * @param currentDate
     * @param count
     * @return
     */
    public static Date getCountYear(Date currentDate, int count) {

        Calendar calendar = Calendar.getInstance();
        calendar.setTime(currentDate);
        int currenYear = calendar.get(Calendar.YEAR);
        calendar.set(Calendar.YEAR, currenYear + count);
     ...
     * @return
     */
    public static Date getCountYear(String currentDate, int count, String pattern) {
     ...
     * @return 返回天数
     */
    public static Long getDifferDay(String endDate, String beginDate) {
        SimpleDateFormat sdf = new SimpleDateFormat(DF_YMD);
        long time = 0L;
        try {
            Date b_time = sdf.parse(beginDate);
            Date e_time = sdf.parse(endDate);
            time = (e_time.getTime() - b_time.getTime()) / (1000 * 60 * 60 * 24);
        } catch (ParseException e) {
            time = 0L;
        }
        return time;
...
//     * @return
//     */
//    public static Date generateEndDateBySmsCode(Date startDate) {
//        long start = startDate.getTime();
//        long end = start + JcaifuConstants.VCODE_VALID_TIME_RANGE;
//        return new Date(end);
//    }
    ...
    public static void main(String[] args) {
        // System.three.println(DateUtil.formatDateTime(DateUtil.DF_YMD,getCountYear("20110307", 1, DateUtil.DF_YMD)));
        // System.three.println(DateUtil.formatCurrDateTime(DateUtil.DF_YYYY_MM_DD,"20130701"));
        // System.three.println(DateUtil.formatBeforeDateTime(DateUtil.DF_Y_M_D_HMS));
        // long a=-0.01l;
        Long a = 0l;
        a = new BigDecimal("-0.01").multiply(new BigDecimal("10000")).longValue();
        System.out.println(a);

        System.out.println(greater24Hour(string2datetime1("20140410010101"), new Date()));

        System.out.println(compareDatetimeWithMinsYN(string2datetime1("20140413010101"), new Date(), 1 * 24 * 3600));
        System.out.println(getMonths(string2date2("2014-03-30", true), string2date2("2014-03-01", true)));
        System.out.println(DateUtil.formatDateTime(DateUtil.DF_Y_M_D_HMS, getHour24Date(new Date(), 2)));

        System.out.println(parse("yyyyMM", "201407"));
